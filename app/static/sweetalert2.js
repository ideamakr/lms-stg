...
!(function (
  ...
  function () {
          ...
          new Promise(
            (
              ...
              const n =
                ...
                i =
                  window.scrollY;
              (o.restoreFocusTimeout =
                setTimeout(
                  () => {
                    o.previousActiveElement instanceof
                    HTMLElement
    ...
    const ke =
      ...
      xe =
        (
          ...
          `<div class="${r["icon-content"]}">${e}</div>`;
    let Te =
        !1,
      Se = 0,
      Oe = 0,
    ...
    function jt() {
      ...
      Z(
        ...
        (t.confirmButton.disabled =
          !1),
        (t.denyButton.disabled =
          !1),
        (t.cancelButton.disabled =
          !1);
    }
    const Ht =
      (
        ...
        const t =
          ...
          n =
            t
              ? e.popup.getElementsByClassName(
                  t
                )
              : [];
        n.length
        ...
        (
          ...
          new Promise(
            (
              ...
              tt.swalPromiseResolve.set(
                e,
                i
              ),
                tt.swalPromiseReject.set(
                  e,
                  s
                ),
    ...
    (Un.prototype.disableButtons =
      Nt),
      (Un.prototype.enableButtons =
        qt),
      (Un.prototype.getInput =
        It),
      (Un.prototype.disableInput =
        Rt),
      (Un.prototype.enableInput =
        _t),
      (Un.prototype.hideLoading =
        jt),
      (Un.prototype.disableLoading =
        jt),
      (Un.prototype.showValidationMessage =
        Ft),
      (Un.prototype.resetValidationMessage =
        Ut),
      (Un.prototype.close =
        dt),
      (Un.prototype.closePopup =
        dt),
      (Un.prototype.closeModal =
        dt),
      (Un.prototype.closeToast =
        dt),
      (Un.prototype.rejectPromise =
        mt),
      (Un.prototype.update =
        nn),
      (Un.prototype._destroy =
        sn),
      Object.assign(
        Un,
        An
